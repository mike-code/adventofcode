...
R = list(itertools.combinations([(0,0,0), (25,1,0),(50,2,0),(100,3,0),(20,0,1),(40,0,2),(80,0,3)], 2))

C = [sum(com) for com in numpy.array([(w,a,r[0],r[1]) for w in W for a in A for r in R])]
CALC = [(c[0], math.ceil(b_hp/max(1, c[1] - b_arm)), math.ceil(100/max(1, b_dmg - c[2]))) for c in C]
